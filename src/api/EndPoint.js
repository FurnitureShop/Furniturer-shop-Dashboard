...
//Backend
export const ENP_LOGIN = "auth/sign-in-seller";
...
export const ENP_GET_ALL_PAID_ORDER = "/order/customerPaidOrder/all";
export const ENP_GET_ALL_ORDER = "/order/customerOrder/all";
